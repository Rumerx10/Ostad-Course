...
export const MONGODB_CONNECTION = "mongodb+srv://rume:rume@cluster0.dwa2j.mongodb.net/user_db?retryWrites=true&w=majority";
...
export const CREATE_FILE_PATH = (fileName) => {                                    // my 
    return path.resolve(process.cwd(), "storage", fileName);
  };
export const UPLOAD_FILE = (fileName) => {                                         // ostad
  return path.resolve(process.cwd(), "storage", fileName);
};
